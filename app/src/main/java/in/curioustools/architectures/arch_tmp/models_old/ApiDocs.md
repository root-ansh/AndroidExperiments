...
returns:
- List of pokemons in format:
```json
    {
      "count": 964,
      "next": "https://pokeapi.co/api/v2/pokemon?offset=205&limit=5",
      "previous": "https://pokeapi.co/api/v2/pokemon?offset=195&limit=5",
      "results": [
        {
          "name": "unown",
...
Custom params:
1. `limits=x` : total no. of items in result
2. `offset=y` : starting index of items (eg if passed 200, we will get results starting from 201)



---

### GET `https://pokeapi.co/api/v2/pokemon/<pokemon_id>` or `https://pokeapi.co/api/v2/pokemon/<pokemon_name>`

returns:
details of pokemon in format:
```json
{
  "abilities": [
    {
...
Custom params:
1. `/pokemon_name` : name of pokemon  **OR**
2. `/pokemon_id` : id  of pokemon
